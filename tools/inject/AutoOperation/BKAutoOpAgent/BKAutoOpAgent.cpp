...
fn_class_get_method_from_name g_class_get_method_from_name;
...
UiPanelLookupResult FindVisiblePanelTransform(const char* panelName, Il2CppObject** panelObj, Il2CppObject** panelTransform, char* error, int errorSize) {
...
bool ResolveUiNodeMatches(Il2CppObject* anchor, const char* path, UiPathMode pathMode, int maxMatches, std::vector<UiNodeSnapshot>* matches) {
